...
Kp_zeta = [50; 50; 10]; % [x, y, z] 3.5
Ki_zeta = [10; 0; 0]; % [x, y, z] 0
Kd_zeta = [10; 100; 5]; % [x, y, z] 4.5

Kp_eta = [100; 100; 10]; % [phi, theta, psi]
Ki_eta = [0; 0; 0]; % [phi, theta, psi]
Kd_eta = [200; 200; 10]; % [phi, theta, psi]
...
% subplot(2,3,4)
% plot(t,phi_ref, 'r', 'linewidth', 1.5); hold on;
...
% 
% subplot(2,3,5)
% plot(t,theta_ref, 'r', 'linewidth', 1.5); hold on;
% plot(t,theta, 'b:', 'linewidth', 2); hold on;
% legend('Reference trajectory', 'Quadrotor trajectory', 'Location', 'best')
% %axis([-1 11 -1 11])
% grid on
% xlabel('t');
...
% 
% subplot(2,3,6)
% plot(t,psi_ref*ones(size(t)), 'r', 'linewidth', 1.5); hold on;
% plot(t,psi, 'b:', 'linewidth', 2); hold on;
% legend('Reference trajectory', 'Quadrotor trajectory', 'Location', 'best')
% %axis([-1 11 -1 11])
% grid on
% xlabel('t');
